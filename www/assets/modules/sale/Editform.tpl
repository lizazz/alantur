<div id="main1">
	<h2><i><?php if(isset($data['title'])) echo "Edit of ".$data['title'];?></i></h2><br>

	<div role="tabpanel">
	  <!-- Nav tabs -->
	  <ul class="nav nav-tabs" role="tablist">
	    <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Main preferences</a></li>
	  ...
	  <div class="tab-content">
	    <div role="tabpanel" class="tab-pane active" id="home">	
				...
				<br>
				<div class="input-group">
					<span class="input-group-addon">Kind of the tour (It may have multiple values)</span><br>
							<div>
								<?php for ($i=0;$i<count($alltype['id']);$i++){
									if(in_array($alltype['id'][$i], $chosentours)) $checked="checked"; else $checked="";
	...
	<br>
	<button type="submit" class="btn btn-small btn-success <?php echo $class;?>">Save</button>	
</div>